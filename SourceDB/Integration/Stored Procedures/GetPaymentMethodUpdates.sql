/*
Example:
   EXEC [Integration].[GetPaymentMethodUpdates] '2013-01-01 00:00:00', '9999-12-31 23:59:59'
*/
...
BEGIN
    ...
    TRUNCATE TABLE Integration.PaymentMethodUpdates;

    INSERT INTO Integration.PaymentMethodUpdates
